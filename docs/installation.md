# NF-TCoffee-tutorial Installation

To start using the NF-TCoffee-tutorial pipeline, there are three steps described below:
...
This pipeline itself needs no installation - NextFlow will automatically fetch it from GitHub if `edgano/nf-tcoffee-tutorial` is specified as the pipeline name.
...
```bash
wget https://github.com/edgano/nf-tcoffee-tutorial/archive/master.zip
unzip master.zip -d /my-pipelines/
cd /my_data/
nextflow run /my-pipelines/nf-tcoffee-tutorial-master
```
